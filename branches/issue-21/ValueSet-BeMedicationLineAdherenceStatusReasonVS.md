# Adherence Status Reason ValueSet - HL7 Belgium terminology Implementation Guide (IG) v1.0.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/medication/ValueSet/BeMedicationLineAdherenceStatusReasonVS | *Version*:1.1.0 | |
| Active as of 2025-10-10 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeMedicationLineAdherenceStatusReasonVS |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "https://www.ehealth.fgov.be/standards/fhir/medication/CodeSystem/BeMedicationLineAdherenceStatusReason"
    }]
  }
}
