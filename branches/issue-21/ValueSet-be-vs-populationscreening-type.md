# Population Screening Type Value Set - HL7 Belgium terminology Implementation Guide (IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Population Screening Type Value Set**

## ValueSet: Population Screening Type Value Set (Experimental) 

| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/public-health/ValueSet/be-vs-populationscreening-type | *Version*:1.0.3 | | |
| Active as of 2024-06-12 | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeVSPopulationScreeningType |
...
Value Set with the codes for the type of screening 
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/public-health/ValueSet/be-vs-populationscreening-type",
  "version" : "1.0.3",
  "name" : "BeVSPopulationScreeningType",
