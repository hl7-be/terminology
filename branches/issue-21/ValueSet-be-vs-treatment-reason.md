...
| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://hl7belgium.org/profiles/fhir/terminology/ValueSet/be-vs-treatment-reason | *Version*:1.0.0 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeVSTreatmentReason |
...
```json
{
  ...
  "url" : "https://hl7belgium.org/profiles/fhir/terminology/ValueSet/be-vs-treatment-reason",
  "version" : "1.0.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://hl7belgium.org/profiles/fhir/terminology/CodeSystem/be-cs-treatment-reason"
    }]
  }
}
