...
| [Speech Therapy Pathology Situation Code](ValueSet-be-vs-speech-therapy-pathology-situation-code.md) | Texte de la nomenclature (Article 36, par. 2) |
...
| [Speech Therapy Pathology Situation code](CodeSystem-be-cs-speech-therapy-pathology-situation-code.md) | Texte de la nomenclature (Article 36, par. 2) |
...
| | |
| :--- | :--- |
| [BeCMISOToothSnomedCT](ConceptMap-BeCMISOToothSnomedCT.md) | ISO tooth numbers to SNOMED CT |
