...
| Active as of 2024-11-12 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeVSPseudonymizationType |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueCanonical" : "https://www.ehealth.fgov.be/standards/fhir/infsec/ValueSet/be-vs-pseudonymization-type"
  }],
