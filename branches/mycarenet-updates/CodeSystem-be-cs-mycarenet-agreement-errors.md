# MyCareNet Agreement errors - HL7 Belgium terminology Implementation Guide (IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MyCareNet Agreement errors**

## CodeSystem: MyCareNet Agreement errors 

| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-mycarenet-agreement-errors | *Version*:2.1.2 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeCSMyCareNetAgreementErrors |
...
* [BeVSMyCareNetEagreementErrors](ValueSet-be-vs-mycarenet-eagreementerrors.md)
...
```json
{
  ...
  "version" : "2.1.2",
  "name" : "BeCSMyCareNetAgreementErrors",
