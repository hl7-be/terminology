# MyCareNet Agreement types - HL7 Belgium terminology Implementation Guide (IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MyCareNet Agreement types**

## CodeSystem: MyCareNet Agreement types 

| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-mycarenet-agreement-types | *Version*:2.1.2 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeCSMyCareNetAgreementTypes |
...
```json
{
  ...
  "id" : "be-cs-mycarenet-agreement-types",
  "extension" : [{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-mycarenet-agreement-types",
  "version" : "2.1.2",
  "name" : "BeCSMyCareNetAgreementTypes",
  "title" : "MyCareNet Agreement types",
  "status" : "active",
  "experimental" : false,
