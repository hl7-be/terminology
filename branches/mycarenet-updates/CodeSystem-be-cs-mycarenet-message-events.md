...
| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-mycarenet-message-events | *Version*:2.1.2 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeCSMyCareNetMessageEvents |
...
* [BeVSMyCareNetMessageEAgreement](ValueSet-be-vs-mycarenet-eagreementmessage.md)
...
```json
{
  ...
  "version" : "2.1.2",
  "name" : "BeCSMyCareNetMessageEvents",
