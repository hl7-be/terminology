# MyCareNet ISO Tooth ConceptMap - HL7 Belgium terminology Implementation Guide (IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MyCareNet ISO Tooth ConceptMap**

## ConceptMap: MyCareNet ISO Tooth ConceptMap 

| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/terminology/ConceptMap/BeCMMyCareNetISOToothSnomedCT | *Version*:2.1.2 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeCMISOToothSnomedCT |
...
```json
{
  ...
  "id" : "BeCMMyCareNetISOToothSnomedCT",
  "extension" : [{
