...
| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://hl7belgium.org/profiles/fhir/terminology/ValueSet/be-vs-requester-norm | *Version*:1.0.0 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeVSRequesterNorm |
...
```json
{
  ...
  "url" : "https://hl7belgium.org/profiles/fhir/terminology/ValueSet/be-vs-requester-norm",
  "version" : "1.0.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://hl7belgium.org/profiles/fhir/terminology/CodeSystem/be-cs-requester-norm"
    }]
  }
}
