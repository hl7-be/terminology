# BeVSVaccinationReasonCode - HL7 Belgium terminology Implementation Guide (IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BeVSVaccinationReasonCode**

## ValueSet: BeVSVaccinationReasonCode 

| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/vaccination/ValueSet/be-vs-vaccination-reason-code | *Version*:1.1.2 | | |
| Draft as of 2025-11-27 | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeVSVaccinationReasonCode |
...
Vaccination reason code Value Set - the reasons for an vaccination 
...
```json
{
  ...
  "compose" : {
    "include" : [{
      ...
      "concept" : [{
        "code" : "409516001",
        "display" : "Post-exposure prophylaxis (procedure)",
        "designation" : [{
          "language" : "nl-BE",
          "value" : "profylaxe na blootstelling"
        }]
      },
      {
        "code" : "1137457009",
        "display" : "Pre-exposure prophylaxis (procedure)",
        "designation" : [{
          "language" : "nl-BE",
          "value" : "profylaxe voorafgaand aan blootstelling"
        }]
      }]
    }]
  }
