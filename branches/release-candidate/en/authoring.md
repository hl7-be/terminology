# Authoring - HL7 Belgium terminology Implementation Guide (IG) v1.0.0
...
For how versions are stated, and pinning versus latest, see [Using terminologies in FHIR](using.md).
