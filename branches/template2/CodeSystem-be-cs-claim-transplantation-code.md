...
| | | | |
| :--- | :--- | :--- | :--- |
| *Official URL*:https://hl7belgium.org/profiles/fhir/terminology/CodeSystem/be-cs-claim-transplantation-code | *Version*:1.0.0 | | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Realm:*![](assets/images/bel.svg) | *Computable Name*:BeCSClaimTransplantationCode |
...
* [BeVSClaimTransplantationCode](ValueSet-be-vs-claim-transplantation-code.md)
...
```json
{
  ...
  "url" : "https://hl7belgium.org/profiles/fhir/terminology/CodeSystem/be-cs-claim-transplantation-code",
  "version" : "1.0.0",
