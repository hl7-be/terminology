# Medication request reimbursement type - HL7 Belgium terminology Implementation Guide (IG) v1.0.0
...
```json
{
  ...
  {
    "code" : "education-and-self-care-program-type-2-diabetes",
    "display" : "\"Education and self-care\" programme for type 2 diabetes",
    "designation" : [{
      "language" : "fr-BE",
      "value" : "Programme « Éducation et autogestion » pour le diabète de type 2"
    },
    {
      "language" : "nl-BE",
      "value" : "Programma \"Educatie en zelfzorg\" diabetes type 2"
    }]
  }]
}
