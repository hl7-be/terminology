...
```json
{
  ...
  "url" : "https://hl7belgium.org/profiles/fhir/terminology/ValueSet/be-vs-id-doc-media-type",
  "version" : "1.0.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://hl7belgium.org/profiles/fhir/terminology/CodeSystem/be-cs-id-doc-media-type"
    }]
  }
}
