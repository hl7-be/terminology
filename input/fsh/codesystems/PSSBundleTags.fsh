CodeSystem: PSSBundleTags
Id: PSSBundleTags
Title: "PSS Bundle Tags"
Description: "PSS Bundle Tags - Feedback, Recommendation"
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.840.1.113883.2.51.22.2.16.7"
* ^version = "1.1.0"
* ^status = #active
* ^experimental = false
...
* ^extension.valueCanonical = "https://www.ehealth.fgov.be/standards/fhir/pss/CodeSystem/PSSBundleTags"
