...
* ^extension[=].valueRelatedArtifact.resource = "https://www.ehealth.fgov.be/standards/fhir/vaccination/ValueSet/be-vs-vaccine-code"
...
* $sct#871839001
// * $sct#871839001 ^designation[0].language = #fr-BE
// * $sct#871839001 ^designation[=].value = "vaccin combiné contenant uniquement les antigènes de Bordetella pertussis, Clostridium tetani, Corynebacterium diphtheriae et l'Haemophilus influenza de type B"
// * $sct#871839001 ^designation[+].language = #nl-BE
// * $sct#871839001 ^designation[=].value = "vaccin enkel tegen difterie, tetanus, kinkhoest, Haemophilus influenzae b"
// * $sct#871839001 ^designation[+].language = #en
// * $sct#871839001 ^designation[=].value = "Vaccine product containing only Bordetella pertussis and Clostridium tetani and Corynebacterium diphtheriae and Haemophilus influenzae type b antigens (medicinal product)"
* $sct#1252690003
// * $sct#1252690003 ^designation[0].language = #fr-BE
// * $sct#1252690003 ^designation[=].value = "vaccin contre le méningocoque A"
// * $sct#1252690003 ^designation[+].language = #nl-BE
// * $sct#1252690003 ^designation[=].value = "vaccin enkel tegen meningokok A"
// * $sct#1252690003 ^designation[+].language = #en
// * $sct#1252690003 ^designation[=].value = "Meningococcus serogroup A vaccine"
* $sct#51451000087105
// * $sct#51451000087105 ^designation[0].language = #fr-BE
// * $sct#51451000087105 ^designation[=].value = "vaccin pneumococcique conjugué 13-valent"
// * $sct#51451000087105 ^designation[+].language = #nl-BE
// * $sct#51451000087105 ^designation[=].value = "vaccin tegen pneumokokken 13 types"
// * $sct#51451000087105 ^designation[+].language = #en
// * $sct#51451000087105 ^designation[=].value = "Vaccine product containing only Streptococcus pneumoniae Danish serotype 1, 3, 4, 5, 6A, 6B, 7F, 9V, 14, 18C, 19A, 19F, and 23F capsular polysaccharide antigens conjugated (medicinal product)"
* $sct#1345202008
// * $sct#1345202008 ^designation[0].language = #fr-BE
// * $sct#1345202008 ^designation[=].value = "produit vaccinal contenant uniquement l'antigène du virus Chikungunya"
// * $sct#1345202008 ^designation[+].language = #nl-BE
// * $sct#1345202008 ^designation[=].value = "vaccin met enkel antigeen van Chikungunya-virus"
// * $sct#1345202008 ^designation[+].language = #en
// * $sct#1345202008 ^designation[=].value = "Vaccine product containing only Chikungunya virus antigen (medicinal product)"
* $sct#777424002
// * $sct#777424002 ^designation[0].language = #fr-BE
// * $sct#777424002 ^designation[=].value = "produit contenant uniquement de l'immunoglobuline contre le virus respiratoire syncytial"
// * $sct#777424002 ^designation[+].language = #nl-BE
// * $sct#777424002 ^designation[=].value = "Product dat enkel immunoglobuline tegen orthopneumovirus bevat"
// * $sct#777424002 ^designation[+].language = #en
// * $sct#777424002 ^designation[=].value = "Product containing only Respiratory syncytial virus immune globulin (medicinal product)"