...
* ^identifier.value = "urn:oid:2.16.840.1.113883.2.51.22.2.48.14"
* ^version = "1.1.0"
* ^status = #active
...
* ^extension.valueCanonical = "https://www.ehealth.fgov.be/standards/fhir/pss/ValueSet/pss-exception-valueset"
