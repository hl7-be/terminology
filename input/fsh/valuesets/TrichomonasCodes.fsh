...
* ^identifier.value = "urn:oid:2.16.840.1.113883.2.51.22.2.48.11"
* ^version = "1.1.0"
* ^status = #active
* ^experimental = true
...
* ^extension.valueCanonical = "https://www.ehealth.fgov.be/standards/fhir/pss/ValueSet/TrichomonasCodes"
* SNOMED_CT#276877003
* SNOMED_CT#35089004